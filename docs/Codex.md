# Rapot teknik bağlamı

Kaynak karşılaştırması: **11 Eylül 2026 / P2-2**. Bu belge mimariyi açıklar;
...
kabulünün tamamlandığı anlamına gelmez. Ayrıntı [middleware README](../middleware/README.md),
...
sınırları P3-1'de açık. Üç motorun bütünüyle eşdeğer olduğu doğrulanmadı.

Seçili ortam Python 3.12, Node 20.20.2/npm 10.9.9; frontend Next 16.2.1 /
...
bağlamaz. PM2 dosyaları legacy'dir, ikinci üretim supervisor'ı değildir.
...
ile host loopback'i karıştırılmaz. [DEPLOY.md](../scripts/DEPLOY.md) doğrulanmış SHA,
