...
[combo_hunter_binance.pine](../middleware/pine/combo_hunter_binance.pine), altı COMBO/HUNTER sinyalini
...
Repo kökünden yerel kaynak sözleşmesi kontrolü:
...
Güncel 1.091 satırlık kaynak, 21 Eylül'de hash'i doğrulanan ayrı özel script ile
TradingView BINANCE:BTCUSDT / standart mum / 1D grafiğinde derlenip çalıştırıldı;
skor tablosu ve `TF OK` görüldü. [Gerçek tarayıcı kabulü](PINE_RUNTIME_ACCEPTANCE.md)
bu dar gözlemi kaydeder; gerçek alarm teslimi ve ALL/FIRST/saat filtresi,
futures/standart olmayan grafik ve emir kabulünün tamamlandığı anlamına gelmez.
[Farklar ve test sınırları](STRATEGY_COMPARISON.md).
...
Ayrıntılı kanıt ve kalan adımlar [devam planında](RAPOT_DEVAM_PLANI.md).
