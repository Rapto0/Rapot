...
- **Son çalışma:** **P2-4 yerel düzeltme/ölçüm ve Linux CI tamamlandı; üretim kabulü açık.** Kod commit'i `aadde728f7e83a636b9493b660fed33434564e9a` main'e gönderildi; [CI 34742590742](https://github.com/Rapto0/Rapot/actions/runs/34742590742) beş job ile başarılı. Bilinmeyen stratejilerin COMBO bildirimi olarak görünmesi ham veri filtresiyle düzeltildi. Python **722 passed / 1 skipped**, frontend **99/99**, lint/type/build/standalone geçti. 1,75 milyon sentetik sinyal +25 bin trade ile sekiz REST/üç WS dalgası ve sürekli iletim/gecikme sınırları doğrulandı. Önceki taslakta P2-4 erken kapatılmıştı; kapasite ve exact sürümle üretim kabulü tamamlanmadan kapatılmayacak.
- **Uygulama durumu:** P0-1–P0-4, P1-1, P1-2, P1-4–P1-7, P1-G1, P2-1 ve P2-3 doğrulandı; P2-2 belge/karar kapsamı tamam. **P2-4 yerel doğrulaması tamam; üretim kabulü açık.** İç worktree ve 12 wrapper koruma kararı değişmedi.
...
- **Aktif iş:** **P2-4 yayın/kapasite ve üretim kabulü.** Kalıcı regresyon ve büyük sentetik veri ölçümü tamamlandı. Kod commit'i `aadde728`, CI başarılı. [İmaj yayını 34742865556](https://github.com/Rapto0/Rapot/actions/runs/34742865556) exact kod için başlatıldı. Nihai CI/imaj/katman maliyeti ve bu belge yayınının hash/CI kanıtı `/root/rapot-ops/20260913-p24/release-record.json` kaydında izlenir; imaj yayını sunucu deploy'u değildir. 12 eski kapalı sistem günlüğünün doğrulanmış bilgisayar kopyası hazır; sunucu orijinalleri korunuyor, kaldırma kararı verilmedi. Sonraki kod işi P3-1; COMBO/Pine ve backtest maliyet/zaman sırası bulguları açık. Bandit MEDIUM/LOW borcu ayrı kalır.
...
- **Açık işler:** P2-4 üretim kabulü, P3-1/P3-2 ve kullanıcı isteğiyle ertelenmiş gerçek TradingView alarm/filtre ve testnet emir kabulü. 13 Eylül 06:02:27 UTC salt okunur ön kontrolde beş servis healthy, eski `ccd61544` backend/frontend imajları çalışıyor; disk **629.215.232 B (~600 MiB)** boş. Ücretli yükseltme yapılmayacak; diğer yedek/imaj/release'ler otomatik silinmeyecek. Yeni dağıtım tamamlanmış sayılmıyor.
...
| P2-4 | Eşzamanlı API yükünde realtime gecikmesi | Yerel doğrulandı — 722 test+99 frontend+1,75M sentetik ölçüm; yayın/üretim kabulü açık | Orta | P1-5 |
...
| P3-1 | Backtest ve strateji eşdeğerliği | İncelendi; COMBO/Pine ve backtest maliyet/tarih sırası düzeltmeleri bekliyor | Büyük | Emir/veri doğruluğu, P1-3, P1-4 |
...
**Durum — 13 Eylül:** Yerel kalıcı doğrulama tamam; yayın/kapasite ve üretim kabulü açık. Üretim hâlâ P1-G1 `ccd61544` sürümünde. Önceki taslağın üst özetindeki “P2-4 doğrulandı” kaydı erkendi; bu tur düzeltildi. Önceki konuşma özetindeki p95 değerlerinin ham koşum kaydı/kodu bulunamadığından kabul kanıtı sayılmadı; yeni ölçüm tekrarlanabilir araçla yapılacak.
...
**Ücretsiz alan hazırlığı — silme yapılmadı:** 13 Eylül 06:16:20 UTC'de yalnız 1 Eylül öncesi **12 ARCHIVED system journal** dosyasının kalıcı bilgisayar kopyası doğrulandı. Gerçek header kayıtları 6–28 Ağustos; Eylül ve aktif `system.journal` hariç. Sunucuda ayrılan toplam **906.018.816 B (~864,05 MiB)**; yerel gzip tar **162.537.514 B**, SHA256 `7bcc55781fec5e9b863bae157d39310cb8c7a69c8cdb244ec429f9519555adcc`. Tam sabit dosya listesi/iki taraflı üye hash'leri `C:\Users\memet\RapotBackups\20260913-p24-journal\verified-copy-manifest.json` içinde; manifest SHA256 `046a20bfd4156239e3e7597702b55c791aa78611b044feb1b8d124250b00f400`. Gzip CRC/footer, üye boyut/SHA, yeniden okunan sunucu inode/mtime/ctime/ARCHIVED state ve özel klasörün yalnız kullanıcı/SYSTEM/Administrators ACL'i geçti. Sunucuda büyük geçici arşiv oluşturulmadı. **Orijinaller hâlâ sunucuda; silme, vacuum, rotation, otomatik retention veya servis restart'ı yapılmadı.** Bu kopya yeni imajın sığacağını tek başına kanıtlamaz; exact katman bütçesi ve somut silme kararı ayrıca gereklidir.

**Commit / uzak doğrulama:** `aadde728f7e83a636b9493b660fed33434564e9a` main'e push edildi. [CI 34742590742](https://github.com/Rapto0/Rapot/actions/runs/34742590742) Python, frontend, lint, report-only güvenlik ve Docker kabulüyle başarılı. Bunun ardından exact kaynak için [imaj yayını 34742865556](https://github.com/Rapto0/Rapot/actions/runs/34742865556) başlatıldı; yayın/pull/üretim kabulü birbirinin yerine geçmez. Kaynak Git arşivi 23.888.014 B, SHA256 `438283331199bbe2f245e5d20041f55e44d30739fef5f985786cf9a2b06b07b8`; upload+açılmış tahmini kaynak alanı **53.399.694 B**. Salt okunur registry ölçeri hem backend/frontend için sıkışık blob hash'i, açılmış diff-ID ve ortak parent-chain'i denetler; 400+128 MiB pay değişmez. Taze backup ve sunucu boş alanı yayın öncesi yeniden ölçülmelidir. Son imaj/kapasite sonucu ve yalnız bu belgenin sonraki commit/CI/canonical hash kanıtları aynı OPS'taki `release-record.json` içindedir; belgenin kendi hash'ine referans döngüsü oluşturulmaz. Sunucuda çalışan uygulama/config/pointer korunarak yalnız küçük kanıt/belge aktarımı yapılır.

**Dosyalar / kapsam / bağımlılık:** `api/main.py`, `infrastructure/repositories/signal_trade_repository.py`, `frontend/src/lib/hooks/use-signals.ts`, yeni concurrency/bildirim/performans testleri. Orta; P1-5 taşımacılığı tamam, üretim kabulü boş disk ve exact yayın kanıtına bağlı.
...
- [ ] Exact sürümle üretim HTTPS/WSS ve kapasite/veri/servis kabulü doğrulandı.
...
| 2026-09-13 | P2-4 | İncele → düzelt → doğrula → belgeyi güncelle | Erken kapanış kaydı düzeltildi. Ham bildirim filtresi, 12 DB-worker success/error/cancel ve4 frontend testi; Python722/skip1, frontend99 ve lint/type/build/standalone geçti. 1,75M/25bin sentetik veri, 8REST/3WS sürekli ölçüm: health9,297ms/WS7,831ms/iletim7,616ms p95, kabul geçti. Üretimccd61544; 600MiB boş disk yeni hazırlığa yetersiz. 12ARCHIVED journalın kalıcı bilgisayar kopyası hash/CRC/header/ACL ile doğrulandı; kaynaklar korunuyor. aadde728 commit/push veCI34742590742 başarılı; imaj34742865556 başlatıldı, son sonuç operator kaydında. Kapasite/üretim kabulü açık; ücretli resize/silme/emir yok |
...
**P2-4 yerel düzeltme/722 test/99 frontend/büyük veri ölçümü tamam; yayın ve üretim kabulü açık; üretim ccd61544 ve DRY_RUN/trading=false/live=false. Kod aadde728 ve CI34742590742 geçti; imaj/kapasite/üretim kabulü operator kaydından sürdürülmeli; P3-1 kod değişikliği başlamadı. Ücretli yükseltme yapılmayacak. Gerçek TradingView alarm/testnet/emir kabulü kullanıcı kararıyla erteli.**
