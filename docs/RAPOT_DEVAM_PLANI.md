...
- **Son çalışma:** **P1-6 yerel uygulama doğrulandı; ilk yayın kabulü zaman aşımıyla geri döndü.** `f61e169` CI/imajı geçti, fakat `/api/health` 20 saniyede yanıtlamadığından uygulama önceki sürüme alındı; DB restore yapılmadı. Dar sağlık probe düzeltmesiyle yeniden yayın hazırlanıyor. Üretim şu anda önceki P1-5 kaynak `a513af9c60e1be1df646bf7acf841e8a9f4c3d89` üzerinde.
- **Uygulama durumu:** P0 işleri, P1-1, P1-2, P1-4, P1-5 ve P1-7 doğrulandı. P1-6 son tam paketi **578/578 Python** (55,65 saniye), **52/52 frontend**, lint/typecheck/build ve yedi Python dosyasında Ruff temiz. 36 yeni Python ve 29 frontend test durumu eklendi. Mevcut UTC yollarından **874 deprecation warning** P2-3'te açık.
...
- **Aktif iş:** **P1-6 yeniden yayın kabulü.** Ek sağlık düzeltmesi sonrası tam Python **588/588** (50,32 saniye), aynı 874 warning; önceki 52 frontend/lint/typecheck/build sonuçları geçerli, frontend kodu bu ek düzeltmede değişmedi. Yeni exact SHA CI/imaj ve yedek sonrası tekrar dağıtılacak. Sonrasında P2-1 dışa aktar/yerel alarm/grafik URL davranışı sırada. Borsa/alarm dış kabulü beklenmiyor.
...
| P1-6 | PnL, bot durumu ve ayarlar ekranı | Yerel doğrulandı; yayın sırada | Orta | P0-1; backend ayar sözleşmesi ve P0-2 |
...
**P0-1–P0-4, P1-1, P1-2, P1-4, P1-5 ve P1-7 tamamlandı. P1-6 ilk kaynak CI/imajı geçti; üretim kabulü health timeout nedeniyle rollback oldu. Ek dar sağlık probe düzeltmesiyle Python588/588 ve Ruff geçti; frontend52/52/lint/typecheck/build önceki aynı frontend kaynağı için geçerli. Yeni CI/yedek/üretim kabulü sırada. Üretim hâlâ a513af9; DRY_RUN/false/false korunuyor. P1-3 dış alarm/emir kabulü kullanıcı isteğiyle ertelendi. Sonraki kod işi P2-1; P2-4 eşzamanlı gecikme ve P3-1 EMA/ATR sınırı açık.**
