...
- **Son çalışma:** **P2-4 `aadde728` üretim geçişi, sağlık ve auth kabulü tamamlandı; eşzamanlı etiket listesi kabulü açık.** 13 Eylül onayıyla dört eski günlük kaldırılarak yaklaşık 288 MiB açıldı; diğer sekiz sunucu günlüğü ve 12 dosyanın özel bilgisayar arşivi korundu. Taze SQLite yedeği tam restore ile doğrulandı. Beş servis sağlıklı, restart sayıları sıfır; auth 13/13 ve ana/PG kayıt sayıları korundu. Dış 8 REST / 3 WSS kontrolünde WS ve sağlık yanıt verdi, ancak iki özel etiket listesi 8 saniyede tamamlanmadı; stats için 5,25 saniye gözlendi. Kısmi indeks ve tam kayıt sayımı düzeltmesi 735 Python testi ve yeni büyük veri ölçümüyle doğrulandı; yeni CI ve üretim kabulü açık.
- **Uygulama durumu:** P0-1–P0-4, P1-1, P1-2, P1-4–P1-7, P1-G1, P2-1 ve P2-3 doğrulandı; P2-2 belge/karar kapsamı tamam. **P2-4 ilk sürümü üretimde; SQL devamının CI ve üretim kabulü açık.** İç worktree ve 12 wrapper koruma kararı değişmedi.
...
- **Önceki sürümün uzak doğrulaması — 11 Eylül:** `ccd61544` için [CI 34641121926](https://github.com/Rapto0/Rapot/actions/runs/34641121926) ve [imaj yayını 34641767731](https://github.com/Rapto0/Rapot/actions/runs/34641767731) başarılı. Üretimde API health 47 ms/200; `/`, `/signals`, `/alarms`, `/chart` SSR 200. Beş servis healthy/restart0; SignalFeed hazır, Binance/BIST sağlayıcıları başlamış. Scheduler 47,298 saniyede unknown → running oldu. 1.733.137 sinyal, 6 tarama geçmişi, 26.393 AI kaydı ve diğer ana sayılar; PostgreSQL kimliği ve 135/135/28/383 sayıları korundu. DRY_RUN/false/false ve AI kapalı; dış Windows HTTPS API/bot kontrolleri ayrı ayrı 203 ms/200. Güncel `aadde728` geçişinin 13 Eylül kanıtı P2-4 bölümündedir.
...
- **Aktif iş:** **P2-4 üretim SQL gecikmesini kapatmak.** Güncel uygulama `aadde728`; ilk dağıtım kanıtı `/root/rapot-ops/20260913-p24-deploy/deployment.json`. Etiket ve tarih alanlarını birleştiren kısmi indeks, özel kopyada 4.980.736 B ek alan kullandı ve geçici sıralamayı kaldırdı. Yerel Python doğrulaması 735 geçti / 1 atlandı (74,35 saniye); yeni büyük veri ölçümü de geçti. Disk bütçesi ve sunucu dışında saklanacak taze yedek doğrulandıktan sonra ikinci geçiş hazırlanacak. Sonraki iş P3-1; gerçek TradingView alarmı ve testnet/emir kabulü erteli.
...
- **Açık işler:** P2-4 eşzamanlı REST/WSS kabulünün SQL devamı, P3-1/P3-2 ve kullanıcı isteğiyle ertelenmiş gerçek TradingView alarm/filtre ve testnet emir kabulü. Ücretli yükseltme veya diğer yedek, imaj, release ve günlükler için toplu silme yapılmaz. İlk P2-4 yayını sonrası boş disk 675.737.600 B; ikinci geçişten önce kalan maliyet yeniden ölçülür.
...
| P2-4 | Eşzamanlı API yükünde realtime gecikmesi | İlk sürüm üretimde; SQL devamı 735 Python testi ve yeni büyük veri ölçümüyle doğrulandı, CI/üretim kabulü açık | Orta | P1-5 |
...
**Durum — 13 Eylül:** İlk `aadde728` sürümünün yerel testleri, büyük veri ölçümü, CI/imaj yayını ve üretim sağlık/auth kabulü tamamlandı. Eşzamanlı üretim kontrolünde özel etiket listeleri zaman aşımına uğradığından **P2-4 açık**. İndeks ve sayım düzeltmesi 735 Python testi ve yeni büyük veri ölçümüyle doğrulandı; bu devamın CI/imaj ve üretim kabulü henüz tamamlanmadı. Önceki taslağın “P2-4 doğrulandı” kaydı erkendi ve düzeltildi. Eski konuşma özetindeki ham koşum kaydı/kodu bulunamayan p95 değerleri kabul kanıtı sayılmadı; aşağıda saklanan, tekrarlanabilir ölçümler kullanılıyor.
...
**P2-4 ilk sürüm `aadde728` üretimde; sağlık/auth kabulü tamam, eşzamanlı etiket listesi kabulü açık. SQL devamı yerelde 735 Python testi ve yeni büyük veri ölçümüyle doğrulandı; CI/imaj ve ikinci üretim geçişi bekleniyor. Onaylı dört eski günlük kaldırıldı; kalan sekiz sunucu günlüğü, 12 dosyanın bilgisayar arşivi ve geri dönüş kaynakları korundu. DRY_RUN/trading=false/live=false sürüyor; P3-1 kod değişikliği başlamadı. Ücretli yükseltme yapılmayacak. Gerçek TradingView alarm/testnet/emir kabulü kullanıcı kararıyla erteli.**
