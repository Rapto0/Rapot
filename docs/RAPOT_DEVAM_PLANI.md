...
- **Aktif iş:** **P2-4 yayın/kapasite ve üretim kabulü.** Kalıcı regresyon ve büyük sentetik veri ölçümü tamamlandı. Yeni commit/CI/imaj kimlikleri ve dağıtım öncesi kapasite sonucu Git dışı operator kanıtında tutulacak. 12 eski kapalı sistem günlüğünün doğrulanmış bilgisayar kopyası hazır; sunucu orijinalleri korunuyor, kaldırma kararı verilmedi. Sonraki kod işi P3-1; COMBO/Pine ve backtest maliyet/zaman sırası bulguları açık. Bandit MEDIUM/LOW borcu ayrı kalır.
...
**P2-4 yerel düzeltme/722 test/99 frontend/büyük veri ölçümü tamam; yayın ve üretim kabulü açık; üretim ccd61544 ve DRY_RUN/trading=false/live=false. Önce exact CI/imaj ve kapasite/üretim kabulü ele alınacak; P3-1 kod değişikliği başlamadı. Ücretli yükseltme yapılmayacak. Gerçek TradingView alarm/testnet/emir kabulü kullanıcı kararıyla erteli.**
