...
- **Aktif iş:** **Sıradaki ana iş P2-4 — eşzamanlı API yükünde realtime gecikmesi.** P1-G1 üretim kabulü kapandı; P2-4 uygulamasına henüz başlanmadı. Önceki UI yükü/heartbeat ve geçici health timeout gözlemleri hâlâ açıklanmış değil; bu dağıtım yük kabulü sayılmaz. P3-1 COMBO sıfır-değer ve Pine EMA/ATR sınırları açık. P0-G1/P1-G1 kapalı olsa da Bandit 15 MEDIUM/1.534 LOW bulgusu ve genel güvenlik report-only politikası ayrı kalır. Borsa/alarm dış kabulü kullanıcı kararıyla erteli.
