# Rapot devam geçmişi — 21 Eylül 2026

> **Tarihsel arşiv; güncel iş talimatı değildir.** Aşağıdaki metin, kaynak planın
> bu tarihteki tam kopyasıdır. Eski “bekliyor”, “sıradaki” ve onay ifadeleri
> kendi tarihsel bağlamlarına aittir; yeni işlem veya yayın yetkisi oluşturmaz.
> Güncel durum ve iş sırası için [güncel devam planını](../RAPOT_DEVAM_PLANI.md) kullanın.

- Kaynak: `docs/RAPOT_DEVAM_PLANI.md`
- Kaynak exact HEAD: `abc918ededf6b491ea6cda707fb1d1005d0eaa84`
- Kaynak Git blob SHA256 (UTF-8/LF, son LF dâhil): `bfbccfc43506a36d0d181c11b73fc90dbef20d72ac2af75990772334333dea9f`
- Kaynak boyutu: **321,177 bayt**; aşağıdaki gövdede tüm cümle, sayı ve kanıt korunur.
- Tek dönüşüm: göreli Markdown dosya hedeflerine `../` öneki eklendi;
  dış URL’ler ve aynı belge içindeki `#anchor` hedefleri değiştirilmez.
  Bu hedef dönüşümü ters çevrildiğinde gövde kaynak Git blobuyla byte-for-byte aynıdır.

---

<!-- ORIGINAL_PLAN_BODY_START -->
# Rapot Devam Planı
...
- **Kapanış yayını:** P3-1 son kod kaynağı `07b7e53dcad9301f56a0da097b36a81541584219`, [CI 35502828849](https://github.com/Rapto0/Rapot/actions/runs/35502828849) ve `/root/rapot-ops/20260920-p31-final/release-record.json` ile doğrulandı (receipt SHA256 `82d32c6c23cc2ea42082dccd3647e704917539e4bb7c6e912543258d6fc75f43`). 21 Eylül Pine ve P3-2 kapanışının altı canonical belgesi ile küçük kabul JSON'u, kendi exact commit/CI ve `/root/rapot-ops/20260921-p31-p32-closure/release-record.json` kaydına bağlanır. Yalnız push sunucu belge kabulü değildir. [Pine kabulü](../PINE_RUNTIME_ACCEPTANCE.md) ve [backup kararı](../BACKUP_BRANCH_REVIEW.md) ayrıntıları içerir.
...
- **Açık işler:** Planın P3-1/P3-2 geliştirme ve karar kapsamı kapandı. Kullanıcı tarafından ertelenen gerçek TradingView alarm teslimi, ALL/FIRST/saat filtresi, futures/standart olmayan grafik runtime korumaları ve testnet/gerçek emir kabulü yeniden seçilene kadar erteli kalır. Gerçek sağlayıcı/gerçek kazanç, tam motor eşdeğerliği ve opsiyonel PNG/paralel runner kabulü iddia edilmez. Ücretli yükseltme ve kapsam dışı silme yok; her yayın öncesinde 528 MiB sabit rezerv yeniden doğrulanır.
...
| P3-1 | Backtest ve strateji eşdeğerliği | **Doğrulandı:** altı kod adımı, 996 Python / 1 atlanan ve 113 frontend, gerçek fixture CLI; 21 Eylül exact kaynak TradingView derleme/grafik kabulü tamam | Büyük | P1-3 gerçek alarm/filtre/emir kabulü ayrı ve erteli |
| P3-2 | Backup branch tasarım değerlendirmesi | Doğrulandı: beş commit ve 18 frontend dosyası incelendi; aktarım seçilmedi, güncel tasarım ve backup ref korundu | Küçük inceleme | Belge/karar kapsamı; yeni UI değişikliği yok |
...
**Sonraki iş:** P3-1 ve P3-2 kapandı. Bu planda borsa emri gerektirmeyen seçilmiş geliştirme kalmadı; P1-3 gerçek alarm/filtre/emir kabulü kullanıcı yeniden seçene kadar ertelidir. Eski backlog kutuları veya backup ref'i otomatik yeni iş başlatmaz.
...
**Durum — 21 Eylül: Doğrulandı.** Altı geliştirme adımı, tekrarlanabilir CLI ve
güncel Pine derleme/grafik kabulü tamamlandı. Aşağıdaki tarihsel açık kapılar
21 Eylül kapanış kaydıyla kapandı; P1-3 gerçek alarm/filtre/emir kapsamı ayrı kaldı.
...
- [x] Güncel 1.091 satırlık Pine kaynağı, exact hash kontrolüyle 21 Eylül'de TradingView BINANCE:BTCUSDT / standart mum / 1D grafiğinde derlenip çalıştırıldı; skor tablosu ve TF OK görüldü. [Ayrı gerçek tarayıcı kabulü](../PINE_RUNTIME_ACCEPTANCE.md) eski kullanıcı sonucunun veya dar kaynak testlerinin yerine geçirilmedi.
...
**20 Eylül P3-1 beşinci adım — ortak nakit ve portföy değerleme:**

- Başlangıç `cc215ae32f696af82670a06e558cf14433120869`, temiz main; önceki
  P1-G2 kapanış [CI35499269819](https://github.com/Rapto0/Rapot/actions/runs/35499269819)
  ve sunucu kabulü tamam. Önceki release-record SHA256
  `c154db324b427cfb9b3f411bfabed4e905544a9759cb43899f8dd0400a080e3d`.
  Yeni çalışma ortak nakit/fiyatlama kapsamındadır; eski boş kutular bütün P3'ün
  tamamlandığı anlamına getirilmedi.
- **Eski kodda iki RED:** AAA'nın 10 Mart satışından gelen nakitle BBB'nin
  5 Mart alışının yapılması; iki açık pozisyonun kapanış değeri **260** olması
  gerekirken diğer sembolün alış fiyatına dönülmesiyle **210** raporlanması.
  Sentetik sağlayıcı/sinyal fixture'leri gerçek `run_backtest` döngüsünü sınadı.
  `runtime-data/p31-shared-portfolio-red.log` SHA256
  `7db4c15887e09ad4ee0feec939f5763b6228075763d09797e6f9d26f8c75cb1c`.
- `run_backtest(..., data_by_symbol=..., costs=...)` tüm sabit eşleme anahtarlarını,
  sembolleri ve uygun OHLCV'yi ilk işlemden önce doğrular/kopyalar. Sabit girdi
  sağlayıcıya gitmez; normal yol sembol başına bir kez okur. Hatalı girdi veya
  sağlayıcı istisnası kısmi başarılı sonuç olarak gizlenmez. Sağlayıcı `None`,
  120'den az uygun satır ve işlem günü yokluğu, `backtest_metadata` içindeki atlama
  nedenleriyle açıkça ayrılır. İşlenmiş/sinyalsiz sembol atlanmış sayılmaz.
- Sıralı sembol akışları tek tarih akışında birleştirilir. Aynı gün ham sembol
  metni sırası kullanılır; giriş listesini ters çevirmek nakit tahsisini değiştirmez.
  COMBO→HUNTER ve ÇOK UCUZ→BELEŞ→PAHALI sırası, sabit bütçe, FIFO ve önceki
  prefix→sonraki gerçek Open sözleşmesi korunur. Tüm satışları önceye alan yeni
  strateji kuralı yoktur. Aynı gün önceki sembol sonraki sembolün nakdini etkiler.
- Her ortak işlem gününde bütün Open işlemleri sonrasında bir equity kaydı
  üretilir; bütün açık lotlar son gözlenen Close ile değerlenir. Eksik gün ve
  erken biten feed son kapanışı taşır; gelecek fiyat, sıfır veya son lot alış
  fiyatına fallback yoktur. `Fiyat Tarihleri` ve `Eski Fiyatlı Semboller` alanları
  taşınan fiyatları görünür yapar. Taşıma süresi sınırsızdır; delist/askı veya
  gerçekleşebilir satış fiyatı modeli değildir. Bir koşum tek piyasa ve para
  birimi kullanır; döviz dönüşümü eklenmedi.
- `get_portfolio_value` her açık sembol için açıkça verilen sonlu/pozitif fiyat ister.
  Eksik/geçersiz fiyat ve geleceğe tarihli fiyat kaydı hata verir, equity'yi
  değiştirmez. Tek sembol yolu, kaynak indeksinin 10'un katlarında ve son uygun
  günde kayıt sıklığını korur; başka sembolde açık pozisyon
  varsa sağlayıcı/işlem öncesinde reddeder. Paralel runner bağımsız sermayeli
  deneyler olarak kalır ve çıktı etiketi bunu açıklar. Gerçekleşmiş PnL raporları
  NAV ile değiştirilmedi; benchmark/WFA ayrı açık iş olarak korunur.
- **44/44 yeni regresyon**, tam Python **922 geçti / 1 isteğe bağlı performans
  testi atlandı**, uyarı yok. Yeni test dosyası dahil değişen kaynaklarda Ruff
  lint/format geçti; Git'in izlediği 225 Python dosyasının kontrolü de geçti.
  İlk tam koşum başladıktan sonra iki koruma testi eklendiği için nihai dosya
  hâliyle tam paket yeniden koşuldu. Sabit veri sırası/değişmezlik, sembol sırasına
  göre nakit önceliği, ayrık takvim, BIST/CRYPTO kapanışı, 61/120 sınırı,
  eskimiş/geleceğe tarihli fiyat,
  Kahan dahil hata atomikliği, aynı gün eylem sırası ve ücretli FIFO oracle geçti.
  Frontend tip kontrolü ve production build de geçti; frontend kaynağı değişmedi.
  CLI, gerçek sağlayıcı, Excel/grafik veya borsa emri çalıştırılmadı.
- [Ortak portföy sözleşmesi](../BACKTEST_PORTFOLIO.md), günlük yürütme ve muhasebe
  belgeleri birlikte güncellendi. Minimum 120 satır kuralı gelecekteki kabul edilmiş
  satırlarla yeterlilik kazanabilir; bu tarihsel sembol evreni/survivorship
  modeli değildir. Hesaplayıcı/Pine eşdeğerliği varsayılmadı.
- Yerel loglar `p31-20260920-portfolio-green.log` ve
  `p31-20260920-portfolio-full-final.log`; küçük kabul JSON'u
  `p31-20260920-portfolio-local-acceptance.json`, SHA256 `da2f67f4b33f3bc7693fad7f17386c5241b25355e54a1ef334f9454d518008ff`.
  Kaynak ve yeni testin LF-normalize hashleri bu JSON'a bağlıdır. Exact başarılı
  CI sonrasında sekiz canonical Git dosyası ve bu kabul JSON'u
  `/root/rapot-ops/20260920-p31-portfolio/` dizinine aktarılır. Tam kaynak commit,
  CI, Git blob hashleri, taze kapasite/HTTPS ve değişmeyen runtime kabulü
  `release-record.json` içinde tutulur; yerel karşılığı
  `p31-20260920-portfolio-release-record.json` dosyasıdır.
  Bu sınırlı kaynak yayını container içindeki CLI'yi veya servisleri güncellemez.
...
**21 Eylül P3-1 son dış kriter — gerçek TradingView kabulü:**

- İlk denemede güncel kaynak editöre tam hash ile aktarıldı ve ayrı özel script
  kaydedildi; başka Chrome oturumu nedeniyle veri bağlantısı kesildi. Bu ilk
  deneme çalışma kabulü sayılmadı. Kullanıcı diğer grafikleri kapattığını
  bildirdikten sonra yeni bağlantı ve ayrı kabul yerleşimi açıldı.
- **17:57:58 UTC** kabulü: `BINANCE:BTCUSDT`, standart `Candles`, `1 day`;
  Manuel preset ve varsayılan `2W/3W/M/2M`. Kaydedilen script yeniden açıldı,
  editörden geri kopyalanan 1.091 satırlık metnin LF normalize SHA256'sı
  `59ade54a6677a731deedeb4fd5e229b2c97099d27e2e90c502f3967a45cc672f`
  ile eşleşti. Add to chart sonrası skor tablosu, `TF OK`, `HMax:15`, `CMax:4`
  ve güncellenen fiyatlar görüldü. Görünür compile/runtime hatası yok;
  sıfır derleyici uyarısı iddiası yok. Ayrı özel script/yerleşim kaydedildi.
- Strateji raporunun 1 Ekim 2017–21 Eylül 2026 aralığı ve trade data bildirimi
  bu scriptin emir üretmeyen grafik/alert yapısına uygundur; kâr ölçümü değildir.
  Alarm oluşturulmadı/değiştirilmedi; gerçek webhook ve emir gönderilmedi.
  [Pine kabul belgesi](../PINE_RUNTIME_ACCEPTANCE.md) ayrıntıları ve ertelenen
  filtre/grafik/emir kapsamını açıklar. **P3-1'in tüm kendi kriterleri kapandı.**
- Git dışı `p31-pine-runtime-acceptance-20260921.json` raw SHA256
  `c6dd1729d32600f58aeef89375c7beb613f642df940b999b098bfe16f35c8122`.
  Bu gözlem tutanağı TradingView imzalı rapor değildir. 20 Eylül'deki bağlı
  tarayıcı yokluğu artık güncel engel değildir; tarihsel kayıt korunur.
- Bugünkü mevcut regression kontrolleri **62 Python / 9 frontend** geçti;
  Pine, frontend veya backend kodu değişmedi. Altı canonical belge ve küçük
  kabul kaydı exact başarılı CI'dan sonra
  `/root/rapot-ops/20260921-p31-p32-closure/` altına aktarılır.
  `release-record.json` tam SHA/CI, blob hashleri ve taze sağlık/kapasite/runtime
  kontrolünü tutar. Yerel karşılığı `p31-p32-closure-release-record.json`.
  Sabit 528 MiB rezerv + 2 MiB yayın bütçesi korunur; servis/imaj/DB değişikliği yok.
...
**13 Eylül P1-G2 — incele → düzelt → yerel doğrula:**

- 46 advisory için bakımcı ve registry kaynakları, prod/dev yolu, OS/özellik önkoşulları ve seçilen düzeltme sürümleri [FRONTEND_DEPENDENCY_SECURITY.md](../FRONTEND_DEPENDENCY_SECURITY.md) içinde tek tek kaydedildi. Windows RCE işletim sistemi koşulu üretimde yok; self-hosted WebSocket SSRF ve optimizer yüzeyi kaynak aramasıyla elenmedi. İstismar testi yapılmadı.
- `next` / `eslint-config-next` **16.3.5** birlikte sabitlendi. `minimatch@3.1.5` için brace-expansion **1.1.18**, `minimatch@9.0.9` için **2.1.4** override'ı kullanılır. Önce `npm install --package-lock-only --ignore-scripts` ile 11 → 5; yalnız `@babel/core @humanfs/node baseline-browser-mapping browserslist js-yaml` için `npm update --package-lock-only --ignore-scripts` ile 5 → 0 bulgu. Diğer doğrudan sürümler ve Node 20.20.2/npm 10.9.9/React 19.2.3 korunur.
- Yeni lock: 506 kayıt (kök dahil), **505 bağımlılık düğümü**; 76 değişen kayıt, Next/SWC/Sharp platform paketleri ve hedefli bağımlılık alt ağaçları dahil. PostCSS **8.5.23**, sharp **0.35.4**, nanoid **3.3.19**, Babel core **7.29.7**, humanfs **0.16.8**, baseline **2.11.23**, browserslist **4.28.9**, js-yaml **4.3.2**. Native Windows `sharp.versions`: heif **1.23.2**, vips **8.18.6**. Linux imaj doğrulaması ayrıca gerekir.
- `frontend/scripts/audit-dependencies.mjs` ve sekiz ağsız test eklendi. Aynı npm yürütücüsüyle sabit prod/dev/optional/peer ve registry argümanları kullanılır; JSON yapısı, sürüm/kapsam sayıları, finding-node eşleşmesi, çıkış kodu ve lock'un koşum sırasında değişmemesi doğrulanır. Tailwind'in altı bundled bağımlılığı parent beyanıyla dahil edilir. Her bulgu, timeout/ağ/araç hatası veya eksik/geçersiz rapor CI'yi başarısız yapar; Python report-only politikası ayrı kalır.
- Bağımsız review, npm çevrimdışı ayarının registry'ye gitmeden boş audit raporu üretebildiğini gösterdi. `--offline=false` zorlandı ve argüman regresyonu eklendi; sekiz test yeniden geçti. Ortam `npm_config_offline=true` iken final guard açık online argümanla 505/0 kabulü verdi; kanıt `runtime-data/p1g2-npm-security-online-override/` içinde.
- CI frontend işinde yeni audit adımı ve `always()` artifact; npm scripts, README'ler ve AGENTS güncellendi. Ham npm stdout/stderr, lock SHA/kapsam manifesti ve özet `security-reports/npm/` altına yazılır; üretilen klasör `.gitignore` içindedir. Yerel kanıt `runtime-data/p1g2-npm-security/` içinde; **505/505 kapsam, 0 bulgu**, guard başarılı.
- Temiz `npm ci`, **113/113 frontend testi**, lint, ayrı typecheck, Next 16.3.5 build ve gerçek standalone HTTP/statik/chart SSR-RSC/auth proxy/bot proxy/WS smoke geçti. Tam Python **878 geçti / 1 isteğe bağlı performans testi atlandı**, **uyarı yok**, 101,38 sn. Kaynak Python davranışı veya veritabanı şeması değişmedi. İlk audit denemesinde bundled kayıtlar için yakalanan guard eksikliği ayrı regresyonla düzeltildi; final kontrol geçti.
- `npm ls --all` iki **extraneous** bildirir: `@img/sharp-wasm32` ve `@emnapi/runtime`. Platform filtresiyle kurulmamış optional ebeveynlerin ortak çocukları; sürüm/resolved/integrity ana ve hidden lock ile aynı ve ikisi de audit kapsamındadır. npm/cli PR9221 aynı davranışı düzeltir. Uyarı başarıya çevrilmedi; paket silme/prune veya npm major değişikliği yapılmadı.
- Yerel test çıktıları `runtime-data/p1g2-frontend-tests.log`, `p1g2-python-tests.log`; paket farkı `p1g2-lock-delta.json`, advisory kanıtı `p1g2-advisory-source-review.json`, native/source ve humanfs istisna incelemesi ayrı ignored kayıtlardır. Bu kanıtlar gerçek emir veya tam üretim kabulü sayılmaz.
- Salt okunur üretim: **12:22:02 UTC**, beş servis healthy/restart0, dış HTTPS API/bot 200; frontend `967f137`, backend/Compose/current `279aa9f`. **617.889.792 B** boş, 528 MiB rezerv üzerinde **64.241.664 B**. Yeni imajın gerçek ek katman alanı henüz ölçülmedi; deploy başarısı varsayılmadı. Önceki özel arşiv hash'i eşleşti, diğer altı günlük korundu; yeni silme yetkisi yok. Ayrı kaynak inceleme / OCI ölçer / boş pinli frontend-only operator hazır, 18 sentetik kontrol ve server Python 3.10 AST geçti; execute yapılmadı.

**Önceki P3-1 dördüncü adım kapanış belgesi kabulü:** `d79f4cc841b3de411777730eb91a245ade96cd6e`, [CI 34756245850](https://github.com/Rapto0/Rapot/actions/runs/34756245850) beş iş başarılı. `/root/rapot-ops/20260913-p31-execution-closure/release-record.json` **8.896 B**, SHA256 `2b364a0a4bf6d31ee146cb118f4898fbacff74e8fda27ac5e1178308aa59fd1f`; **274.149 B** belge hash'i ve önceki kaynak receipt'i yeniden doğrulandı. 12:13:26 UTC dış sağlık API194,663 ms / bot227,228 ms / 200; son boş alan618.573.824 B. Bu kabul yeni P1-G2 frontend imajını kapsamıyor.

**13 Eylül P1-G2 — commit/push → CI/imaj → ölçülmüş kapasite açığı:**

- Kaynak **`bbd9377cfd3e8b74f6b02ba23c1c99282ba587bd`**; [CI 34757348090](https://github.com/Rapto0/Rapot/actions/runs/34757348090) beş iş başarılı. Linux Python **878/skip1**, 79,78 sn; frontend **113/113**, lint/type/build/standalone HTTP/WS; yeni audit **505/505 düğüm ve 0 bulgu**. npm artifact10317798527 ZIP SHA256 `ea764356c5b95e8278089c8cde1221494a5ed8f56f2d3af1e3c73e4ca8ddad1e`. Python pip-audit115/0; Bandit225 dosya/1.883LOW+17MEDIUM/0HIGH mevcut report-only sonucudur.
- Exact kaynak için [imaj yayını 34757661535](https://github.com/Rapto0/Rapot/actions/runs/34757661535) başarılı. Kullanılacak frontend index digest **`sha256:e312d7aa5e682a7835e4dc7ba3e1b4263f04a64f872f47037814ec4b0ba1f4d0`**, linux/amd64 platform digest **`sha256:0d738e669a9eeaf7d13635b2e0b39d0142b46f2cd647ec6c38b31c6563c49858`**. Backend imajı workflow tarafından yayımlansa da bu dağıtımda pull/deploy kapsamına girmez; backend/Compose/current279 korunur.
- Kaynak kanıtı d79 baseline'ından yalnız 11 izinli yolu; frontend967'den beri kalan `frontend/tests/strategy-export.mjs` eski test farkını ayrı sabit blob olarak doğrular. `runtime-data/p1g2-source-proof.json` **845.693 B**, SHA256 `73c33f5ede6dba8608feb01aafd3d56554e1db330d7323e97697428964d9a450`; production source pointer taşınmaz, bounded component manifest kullanılacaktır.
- 12:40:52 UTC taze salt okunur disk/snapshot: **616.726.528 B** boş, beş container/config/current aynı. OCI ölçümünde ilk11 katman ortak, **iki yeni katman** var; sıkışık blob **24.651.167 B**, açılmış katman planı **80.797.696 B**, metadata **13.140 B**. Sıkışık SHA ve açılmış diff-ID/parent-chain gerçek stream ile doğrulandı; katmanlar sunucuda indirilmedi veya açılmadı.
- Değişmeyen kabul eşitsizliği: `F > 400 MiB + 128 MiB + 2 MiB evidence/config + C + U + metadata`, yani **F > 661.207.283 B**. Bu ölçüme göre en az **44.480.756 B (~42,42 MiB)** ek alan gerekir. `runtime-data/p1g2-frontend-capacity.json` **9.492 B**, SHA256 `bb3181528ded1f635cfaccc892a19301ad4b29159ddf6feb69fe49cf71dd50b8`. Bu tarihsel maliyet/boş alan ölçümü deploy izni değildir; işlem öncesi tekrar ölçülür.
- Yeni frontend-only operator/source/rollback kontrolleri, 18 sentetik senaryo ve Python3.10 uyumu geçti. Gerçek sourceproof operator doğrulamasından geçti; native Node probe için yedi sentetik kontrol hazır. Staging öncesi exact beş-container/config snapshot yeniden bağlanmalı; ardından yalnız frontend değişir. Native Linux probe, doğru container/image/source ile Next16.3.5, Sharp0.35.4, native libvips ve libheif metadata'sını okuyacak; henüz çalıştırılmadı.
- **Açık kabul:** Yeni tek günlük kaldırma onayı ve taze yedek/kimlik/kullanım doğrulaması → fresh reserve/staging → frontend-only pull/geçiş → HTTPS/SSR/statik/native sürüm kabulü. Kullanıcının eski tek-dosya onayları yeni dosyaya aktarılmaz. Ücretli yükseltme, diğer günlük/yedek/imaj/release/DB silme, gerçek veya testnet emir işlemi yapılmaz. Bu P maddesi üretim kabulü bitmeden Doğrulandı olarak kapatılmaz.

**13 Eylül tek dosyalık kapasite önerisi — tarihsel, 20 Eylül'de aday artık yok:**

- Aday, 17 Ağustos'ta kapanmış **ARCHIVED** sistem günlüğüdür: `/var/log/journal/f17d1cd4476dd2156e8df9fc69737fc6/system@9785d360ea1d4cce9ab534627a929905-0000000000663d09-0006590725c8204a.journal`. Boyut **75.497.472 B**, diskte ayrılan alan **75.501.568 B (~72 MiB)**; SHA256 `db00c9ca24dd5327ac0eda4b25421ce25894ad2f2df1497e6cfc3f1dc89a70f6`. Düzenli dosya, root sahibi, tek hard link; cihaz/inode **64513/516961**. Kimlik, zaman ve hash bilgileri özel yedekle eşleşti.
- **12:47:18 UTC** salt okunur doğrulamada korunan altı eski günlük arşiv durumundaydı. **137 süreç, 1.284 açık dosya tanıtıcısı ve 13.177 bellek eşleme satırında** bu dosyalara referans bulunmadı. Aday için `journalctl --verify` başarılı oldu. Bunlar kontrol anının kanıtıdır; silme öncesi yeniden doğrulanır.
- Aynı ölçümde boş alan **616.316.928 B** idi. Tek dosyanın tahsisli alanı tamamen geri kazanılırsa tahmini boş alan **691.818.496 B**, dağıtım eşiğinin üzerindeki pay **30.611.213 B (~29,19 MiB)** olur. Bu tahmin, eşzamanlı yazıları veya sonraki belge aktarımını içermez; gerçek boş alan yeterli çıkmadan imaj indirilmez.
- Özel bilgisayar arşivinin **12/12 üye hash'i**, gzip CRC'si ve erişim izinleri yeniden doğrulandı. Aday ayrı özel Windows klasörüne geri çıkarıldı; **75.497.472 B** kopyanın SHA256'sı ve ARCHIVED header bilgileri eşleşti. Windows kopyasında `journalctl` çalıştırılmadı; yapısal kontrol hash'i aynı sunucu dosyasında yapıldı. Günlük içeriği rapora veya Git'e alınmadı. Özel doğrulama kaydı `C:\Users\memet\RapotBackups\20260913-p24-journal\p1g2-verification-20260913\backup-verification.json`, **1.802 B**, SHA256 `50503add922a2fdf7a8d6077b4c1aded0c4be5c18ab6f52bbaa9b8eac022efb5`.
...
- Başlangıç `main/e454262d9c13041354534fe312e5b3a1dafe941b`; Git ağacı temiz,
  ...
  `p1g2-capacity-note-release-record.json` içinde korunur.
- **07:26:44 UTC** salt okunur ön kontrolünde beş konteynerin kimliği, imajı,
  başlangıç zamanı, health/restart bilgileri, current ve config hashleri önceki
  kabulün `8ad4e5085fe6a51806b601c03ff6d140af2c293ae8d981038cf8a018b881bac0`
  hash'iyle eşleşti. Frontend `967f137`, backend/Compose/current `279aa9f`.
  Sunucu üzerinden HTTPS API **81,931 ms**, bot **64,818 ms**, ikisi 200.
  **07:33:03 UTC** bağımsız Windows HTTPS ölçümü API **208,805 ms**, bot
  **201,876 ms**, ikisi 200. Bu ölçümler yeni uygulama yayını kabulü değildir.
- `bbd9377` için CI **34757348090** (beş iş) ve imaj yayını **34757661535**
  (bir iş) GitHub API'den tekrar başarılı doğrulandı. Aynı sabit frontend
  digest'inin sıkışık katman SHA'ları, açılmış diff-ID'leri ve ortak zinciri
  yeniden ölçüldü; maliyet değişmedi. Taze ölçüm
  `runtime-data/p1g2-20260920-frontend-capacity.json` içinde. Eşik hâlâ
  **F > 661.207.283 B**; 07:26 boş alanı **498.753.536 B** olduğundan en az
  **162.453.748 B** ek kapasite gerekir. Boş alan sabit 528 MiB rezervin de
  **54.894.592 B** altındadır; rezerv azaltılmaz.
- Node **20.20.2** / npm **10.9.9** ile `npm run audit:dependencies` yeniden
  geçti: **505/505 bağımlılık, 0 bulgu**; paket/lock değiştirilmedi. Sekiz
  dependency-audit testi ve beş frontend sözleşme testi geçti. Ham audit,
  manifest ve özet `runtime-data/p1g2-20260920-npm-security/` içinde.
  Uygulama kaynağı değişmediği için yerel tam build/Python paketi yeniden
  çalıştırılmadı; 113 frontend/878 Python sonucu 13 Eylül kod kabulüne aittir.
- Eski öneride kalan **altı arşiv günlüğünün tamamı** artık sunucuda yok;
  13 Eylül tek dosya önerisi yürütülemez. Yokluk nedeni bu incelemede
  doğrulanmadı; bu oturumda silme yapılmadı. Güncel dizinde **100 journal**
  görüldü; bu sayı tek başına yokluğun nedenini kanıtlamaz. Eski özel
  162.537.514 B arşivin **12/12 üye hash'i, gzip CRC, gömülü manifest ve
  özel ACL** kontrolü 07:28:10 UTC'de tekrar geçti; SHA256
  `7bcc55781fec5e9b863bae157d39310cb8c7a69c8cdb244ec429f9519555adcc` aynı.
- Yeni adaylar header kapanışları **29, 30 ve 31 Ağustos** olan en eski üç
  sistem günlüğüdür. Düzenli/root/tek hard link kimliği, sabit stat/hash,
  ARCHIVED header ve `journalctl --verify` geçti. Son kontrolde 139 süreç,
  1.260 açık FD ve 12.952 bellek eşleme satırında bu üç dosyaya referans yok.
  Bunlar kontrol anına ait kanıttır; izin sonrası işlem öncesi tekrarlanır.
- SSH stdout üzerinden doğrudan yeni özel bilgisayar klasörüne alınan
  `C:\Users\memet\RapotBackups\20260920-p1g2-journal\three-archived-system-journals-before-20260901.tar.gz`
  **37.299.305 B**, SHA256
  `f7c901de8bdddc005e495e8135b2a17c379654ae101744a4564d2f4a40c5c874`.
  Gzip CRC, **3/3 üye hash'i**, gömülü manifest, ayrı özel klasöre geri
  çıkarılan dosyaların byte/hash kontrolü ve ACL geçti. Sunucuda arşiv
  oluşturulmadı; özel klasör yalnız kullanıcı/SYSTEM/Administrators erişimli.
  Kaynak manifest SHA256
  `aa39dfec4793e4d2f98b8355990842cc020e6b3ad97b495e58b324e97631515c`.
- **07:38:01 UTC** son kontrolde kaynaklar/runtime/config aynı, API **37,610 ms**
  ve bot **57,174 ms** / 200. Boş alan **497.381.376 B**; gereken ek alan
  **163.825.908 B**. İki dosya sonrası tahmin **648.384.512 B** ile yetersiz;
  üçünün toplam tahsisli alanı **226.504.704 B**, tahmini son boş alan
  **723.886.080 B**, yayın eşiğinin üstünde **62.678.797 B** paydır.
  Gerçek kazanç silme sonrası ölçülür; tahmin pull yetkisi değildir.
- Yeni somut öneri `runtime-data/p1g2-20260920-three-journal-removal-proposal.json`,
  **21.433 B**, SHA256
  **`f5e50356a3a838693d90412aa8d3990ac1abfe4d9fc02540e57b82a090311890`**.
  Taze OCI ölçümüne, exact kaynak/CI/imaj ve özel yedeğe bağlıdır.
  **Yeni silme onayı alınmadı**; aşağıdaki üç tam yol dışındaki dosyalar,
  eski/yeni özel yedekler, aktif günlükler, DB/imaj/release/config korunur.

| Yalnız yeni onaya sunulan sunucu kopyası | SHA256 |
|---|---|
| `/var/log/journal/f17d1cd4476dd2156e8df9fc69737fc6/system@9785d360ea1d4cce9ab534627a929905-00000000006c091d-00065a1edbda224a.journal` | `14cd5989703ca607bba9e4a118101f25b448da95834d38ab51d53b69e50ab6eb` |
| `/var/log/journal/f17d1cd4476dd2156e8df9fc69737fc6/system@9785d360ea1d4cce9ab534627a929905-00000000006cff26-00065a2d1a2a6399.journal` | `edb3b2f1f3411df0184cbdbd514ceb23ebddbda86fa2a19fba89559b2ea2e6c5` |
| `/var/log/journal/f17d1cd4476dd2156e8df9fc69737fc6/system@9785d360ea1d4cce9ab534627a929905-00000000006dfb6b-00065a4485cb18e3.journal` | `43fcfc86ebbba44a3490707b055978873f82e22d9522b2834e7fd0e51e83332c` |

- Sunucuda yeni dosya yazımı, imaj indirme, servis restart'ı, ayar değişikliği,
  migration, veritabanı veya borsa işlemi yapılmadı. Bu yalnız belge
  güncellemesinin tam SHA/CI ve belge hash'i
  `runtime-data/p1g2-20260920-checkpoint.json` içinde tutulur; **sunucu belge aktarımı
  kapasite çözülene kadar açık kalır**. Mevcut 13 Eylül release-record yeni
  belgenin veya yeni uygulamanın yayınlandığına kanıt olarak kullanılmaz.
- Yayın hazırlığı review'u: `deploy-p1g2-frontend.py` hâlâ boş kaynak/imaj/CI
  pinli taslaktır. Yeni staging aracı, **ilk sunucu yazısından önce** taze
  beş-container/config/current snapshot'ını yukarıdaki kabul hash'ine bağlamalı;
  operatorün sonradan aldığı `self.before` bunun yerine geçmez. Kaynak/kapasite
  kanıtları, yeni izin ve temizlik sonucu ayrı pinlenir. Native Linux probe
  (Next16.3.5, Sharp0.35.4, heif1.23.2, vips8.18.6; native/musl) ile dış
...
**Kapsam ve karar — 21 Eylül:** Branch diff'i, beş commit ve son committeki 18
frontend dosyası incelendi. Güncel main tasarımını koruma, hiçbir eski kod/belge
aktarmama ve backup ref'i tarihsel referans olarak tutma kararı alındı.
[Ayrıntılı karşılaştırma](../BACKUP_BRANCH_REVIEW.md) tüm SHA'ları, dosya karşılıklarını
ve kararın sınırlarını içerir.

**Kabul kriterleri:**

- [x] Beş commitin güncel main'deki karşılıkları ve tasarım farkları özetlendi.
- [x] Kullanılacak veya bırakılacak parçalar için karar kaydedildi: aktarım seçilmedi.
- [x] Otomatik toplu merge yapılmadı. Aktarım seçilmediğinden yeni UI/API uyum
  testi uygulanamaz; mevcut kod için yeni bir görsel kabul iddia edilmez.

**Kanıt:** İncelenen main `07b7e53dcad9301f56a0da097b36a81541584219`, backup ucu
`d71c196062ea072d4a2e9d82d1f1e3887b28ab17`; ortak atadan ayrım 128/5 commit.
İlk dört commit rehber/smoke-route belgeleridir; hepsi UI tasarımı değildir.
Eski ana sayfanın `scanCount/errorCount.toLocaleString()` çağrıları güncel
nullable sağlık sözleşmesine doğrudan uymaz; `isRunning` ikili yorumu da
loading/unknown ayrımını kaybeder. Bazı lint/tip düzeltmeleri main'de mevcut,
üç eski bileşen P2-3'te bilinçli kaldırılmıştır. Eski değişikliklerin tümünün
birebir taşındığı söylenmez. Checkout/merge/cherry-pick veya branch silme yok.
...
| 2026-09-13 | P1-G2 | İncele → düzelt → yerel doğrula | 46 advisory; Next/eslint16.3.5 ve hedefli lock/override güncellemesi, npm11→0,505düğüm kapsamı. Sekiz audit guard testiyle frontend113; lint/type/build/standalone ve Python878/skip1 uyarısız geçti. npm iki optional warning belgeli. CI/imaj/kapasite/üretim açık; yeni silme yok |

| 2026-09-13 | P1-G2 | CI/imaj → kapasite ölçümü → yeni öneri | bbd9377 CI34757348090/imaj34757661535 başarılı; frontend113/Python878-skip1/npm505-0. İki yeni frontend katmanı, strict661.207.283 B gereksinim; 616.726.528 B boş, ek44.480.756 B gerekli. Pull/restart/silme yok; tek eski journal için yeni yedek/kimlik/kullanım önerisi ve onay açık |
...
**21 Eylül: P3-1 ve P3-2 tamamlandı. Güncel Pine exact hash ile TradingView'da derlenip BINANCE:BTCUSDT / standart mum / 1D grafiğinde çalıştı. Beş backup commitinden aktarım seçilmedi. Kodun 996 Python / 1 atlanan, 113 frontend kabulü ve bugünkü 62 Python / 9 frontend kontrolleri ayrı kayıtlıdır. Kapanış belgesinin exact CI/hash ve sunucu kabulü 20260921-p31-p32-closure/release-record.json içinde tutulur. Gerçek alarm/filtre/testnet/emir kabulü erteli; frontend bbd9377 / backend 279aa9f korunur.**
